...
type FormValues = UpdateRestaurantInput;
...
export function EditRestaurantDialog({
  ...
  async function onSubmit(values: UpdateRestaurantInput) {
    ...
    try {
      ...
      form.setError("root", {
        message: err instanceof Error ? err.message : "Could not update restaurant",
      });
    }
  }
